...
import { heroConfig, airDiffuserProductsConfig } from '../config';
import type { Product } from '../config';

interface AirDiffuserCollectionProps {
  onAddToCart: (product: Product) => void;
}

const AirDiffuserCollection: React.FC<AirDiffuserCollectionProps> = ({ onAddToCart }) => {
  ...
  let filteredProducts = airDiffuserProductsConfig.products;
...
export default AirDiffuserCollection;
